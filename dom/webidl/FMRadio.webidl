...
interface FMRadio : EventTarget {
   ...
   * successfully.
   */
  Promise<undefined> enable(double frequency);
   ...
   * frequency attribute.
   */
  Promise<undefined> setFrequency(double frequency);
