...
function _prepareConfig(_args) {
  ...
  args.digest =
    args.digest ||
    new Uint8Array([
      0x00, 0x41, 0x7e, 0x5f, 0xe2, 0xdd, 0xaa, 0xed, 0x11, 0x90, 0x0e, 0x1d,
      0x26, 0x10, 0x30, 0xbd, 0x44, 0x9e, 0xcc, 0x4b, 0x65, 0xbe, 0x2e, 0x99,
      0x9f, 0x86, 0xf0, 0xfc, 0x5b, 0x33, 0x00, 0xd0,
    ]);
...
function _installTests() {
  ...
  add_test(function test_enforceChecksumValidityWithInvalidChecksum() {
    var badDigest = new Uint8Array([
      0x01, 0x02, 0x03, 0x04, 0x05, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b,
