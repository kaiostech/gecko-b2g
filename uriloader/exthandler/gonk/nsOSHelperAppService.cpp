...
nsresult nsOSHelperAppService::UnescapeCommand(const nsAString& aEscapedCommand,
  ...
  LOG("UnescapeCommand really needs some work -- it should actually do some "
      "unescaping\n");
...
already_AddRefed<nsMIMEInfoBase> nsOSHelperAppService::GetFromType(
  ...
  RefPtr<nsMIMEInfoGonk> mimeInfo = new nsMIMEInfoGonk(aMIMEType);
...
nsOSHelperAppService::GetProtocolHandlerInfoFromOS(const nsACString& aScheme,
  ...
  nsMIMEInfoGonk* handlerInfo =
      new nsMIMEInfoGonk(aScheme, nsMIMEInfoBase::eProtocolInfo);
