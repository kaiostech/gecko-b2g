...
bool VoldProxy::OnUserAdded(int32_t aUserId, int32_t aUserSerial, int32_t aSharesStorageWithUserId) {
  IMPL_VOLD_FUNCTION(onUserAdded, aUserId, aUserSerial, aSharesStorageWithUserId);
}
#else
