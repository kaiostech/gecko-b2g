...
const { KillSwitchMain } = ChromeUtils.import(
...
function install_common_tests() {
  ...
  add_test(function test_writeStateProperty() {
    ...
    let state = KillSwitchMain._libcutils.property_get(
      "persist.moz.killswitch"
    );
  ...
  add_test(function test_restoreUserValues() {
    ...
    KillSwitchMain.restoreUserValues()
      .then(e => {
        ok(e, "should have succeeded");
        ...
        strictEqual(e.properties["dalvik.vm.heapmaxfree"], "32m");
        strictEqual(e.properties["dalvik.vm.isa.arm.features"], "fdiv");
        strictEqual(e.properties["dalvik.vm.lockprof.threshold"], "5000");
        strictEqual(e.properties["net.bt.name"], "BTAndroid");
        strictEqual(
        ...
        strictEqual(
          KillSwitchMain._libcutils.property_get(
