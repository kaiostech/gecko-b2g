...
void DOMCameraControlListener::OnHardwareStateChange(HardwareState aState,
                                                     nsresult aReason) {
  class Callback : public DOMCallback {
   public:
    Callback(nsMainThreadPtrHandle<nsISupports> aDOMCameraControl,
             HardwareState aState, nsresult aReason)
        : DOMCallback(aDOMCameraControl), mState(aState), mReason(aReason) {}

    void RunCallback(nsDOMCameraControl* aDOMCameraControl) override {
...
void DOMCameraControlListener::OnPreviewStateChange(PreviewState aState) {
  class Callback : public DOMCallback {
   public:
    Callback(nsMainThreadPtrHandle<nsISupports> aDOMCameraControl,
             PreviewState aState)
        : DOMCallback(aDOMCameraControl), mState(aState) {}
...
void DOMCameraControlListener::OnRecorderStateChange(RecorderState aState,
                                                     int32_t aStatus,
                                                     int32_t aTrackNum) {
  class Callback : public DOMCallback {
   public:
    Callback(nsMainThreadPtrHandle<nsISupports> aDOMCameraControl,
             RecorderState aState, int32_t aStatus, int32_t aTrackNum)
  ...
  NS_DispatchToMainThread(
      new Callback(mDOMCameraControl, aState, aStatus, aTrackNum));
}
...
void DOMCameraControlListener::OnConfigurationChange(
  ...
  class Callback : public DOMCallback {
   public:
    Callback(nsMainThreadPtrHandle<nsISupports> aDOMCameraControl,
             const CameraListenerConfiguration& aConfiguration)
        : DOMCallback(aDOMCameraControl), mConfiguration(aConfiguration) {}
...
void DOMCameraControlListener::OnAutoFocusMoving(bool aIsMoving) {
  class Callback : public DOMCallback {
   public:
    Callback(nsMainThreadPtrHandle<nsISupports> aDOMCameraControl,
             bool aIsMoving)
        : DOMCallback(aDOMCameraControl), mIsMoving(aIsMoving) {}
...
void DOMCameraControlListener::OnFacesDetected(
    const nsTArray<ICameraControl::Face>& aFaces) {
  class Callback : public DOMCallback {
   public:
    Callback(nsMainThreadPtrHandle<nsISupports> aDOMCameraControl,
             const nsTArray<ICameraControl::Face>& aFaces)
        : DOMCallback(aDOMCameraControl), mFaces(aFaces.Clone()) {}
...
void DOMCameraControlListener::OnShutter() {
  class Callback : public DOMCallback {
   public:
...
void DOMCameraControlListener::OnAutoFocusComplete(bool aAutoFocusSucceeded) {
  class Callback : public DOMCallback {
   public:
    Callback(nsMainThreadPtrHandle<nsISupports> aDOMCameraControl,
...
void DOMCameraControlListener::OnTakePictureComplete(
  ...
  class Callback : public DOMCallback {
   public:
    ...
    void RunCallback(nsDOMCameraControl* aDOMCameraControl) override {
      RefPtr<nsDOMCameraControl> camera =
          do_QueryObject(mDOMCameraControl.get());
      RefPtr<Blob> picture = Blob::CreateMemoryBlob(
          camera->GetOwnerGlobal(), static_cast<void*>(mData),
  ...
  NS_DispatchToMainThread(
      new Callback(mDOMCameraControl, aData, aLength, aMimeType));
}

void DOMCameraControlListener::OnUserError(UserContext aContext,
                                           nsresult aError) {
  class Callback : public DOMCallback {
   public:
    Callback(nsMainThreadPtrHandle<nsISupports> aDOMCameraControl,
             UserContext aContext, nsresult aError)
        : DOMCallback(aDOMCameraControl), mContext(aContext), mError(aError) {}

    virtual void RunCallback(nsDOMCameraControl* aDOMCameraControl) override {
...
void DOMCameraControlListener::OnPoster(BlobImpl* aBlobImpl) {
  class Callback : public DOMCallback {
   public:
    Callback(nsMainThreadPtrHandle<nsISupports> aDOMCameraControl,
             BlobImpl* aBlobImpl)
        : DOMCallback(aDOMCameraControl), mBlobImpl(aBlobImpl) {}
