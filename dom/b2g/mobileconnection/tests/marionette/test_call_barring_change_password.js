...
function testChangeCallBarringPassword(aExpectedError, aOptions) {
  log(
    "Test changing call barring password from " +
      aOptions.pin +
      " to " +
      aOptions.newPin
  );

  return changeCallBarringPassword(aOptions).then(
    function resolve() {
...
startTestCommon(function() {
  return (
    Promise.resolve()
      ...
      .then(() =>
        testChangeCallBarringPassword("InvalidPassword", {
          pin: null,
          newPin: "0000",
        })
      )
      ...
      .then(() =>
        testChangeCallBarringPassword("IncorrectPassword", {
          pin: "1111",
          newPin: "2222",
        })
      )
      ...
      // Sucessful
      .then(() =>
        testChangeCallBarringPassword(null, {
          pin: "0000",
          newPin: "2222",
        })
      )
