...
uint32_t GetFMRadioFrequency() { return 0; }

bool IsFMRadioOn() { return false; }

uint32_t GetFMRadioSignalStrength() { return 0; }

void CancelFMRadioSeek() {}

bool EnableRDS(uint32_t aMask) { return false; }
