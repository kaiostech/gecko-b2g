...
startTestCommon(function testCaseMain() {
  ...
  return (
    testGetThreads([
      { incoming: false, address: "5555211001", text: "thread 1" },
    ])
      // [Thread 2]
      ...
      .then(() =>
        testGetThreads([
          { incoming: false, address: "5555211002", text: "thread 2-1" },
      ...
      .then(() =>
        testGetThreads([
          { incoming: false, address: "+15555211003", text: "thread 3-1" },
      ...
      .then(() =>
        testGetThreads([
          { incoming: true, address: "5555211004", text: "thread 4" },
        ])
      )
      // [Thread 5]
      ...
      .then(() =>
        testGetThreads([
          { incoming: true, address: "5555211005", text: "thread 5-1" },
      ...
      .then(() =>
        testGetThreads([
          { incoming: true, address: "+15555211006", text: "thread 6-1" },
      ...
      .then(() =>
        testGetThreads([
          { incoming: false, address: "5555211007", text: "thread 7-1" },
      ...
      .then(() =>
        testGetThreads([
          { incoming: true, address: "5555211008", text: "thread 8-1" },
      ...
      .then(() =>
        testGetThreads([
          { incoming: false, address: "+15555211009", text: "thread 9-1" },
      ...
      .then(() =>
        testGetThreads([
          { incoming: false, address: "+15555211010", text: "thread 10-1" },
      ...
      .then(() =>
        testGetThreads([
          { incoming: false, address: "01115555211011", text: "thread 11-1" },
      ...
      .then(() =>
        testGetThreads([
          { incoming: false, address: "01115555211012", text: "thread 12-1" },
      ...
      .then(() =>
        testGetThreads([
          { incoming: false, address: "5555211013", text: "thread 13-1" },
      ...
      .then(() =>
        testGetThreads([
          { incoming: false, address: "5555211014", text: "thread 14-1" },
      ...
      .then(() =>
        testGetThreads(
          [
            { incoming: false, address: "5555211015", text: "thread 15-1" },
      ...
      .then(() =>
        testGetThreads([
          { incoming: false, address: "+551155211017", text: "thread 17-1" },
      ...
      .then(() =>
        testGetThreads([
          { incoming: false, address: "1155211018", text: "thread 18-1" },
