...
Presenter.prototype = {
  ...
  textChanged: function textChanged(
    aAccessible,
    aIsInserted,
    aStartOffset, // jshint ignore:line
    aLength,
    aText,
    aModifiedText
  ) {}, // jshint ignore:line
   ...
   */
  liveRegion: function liveRegionShown(
    aContext,
    aIsPolite,
    aIsHide, // jshint ignore:line
    aModifiedText
  ) {}, // jshint ignore:line
...
VisualPresenter.prototype.pivotChanged = function VisualPresenter_pivotChanged(
  ...
  try {
    ...
    let bounds =
      aContext.startOffset === -1 && aContext.endOffset === -1
        ? aContext.bounds
        : Utils.getTextBounds(
            aContext.accessibleForBounds,
...
VisualPresenter.prototype.tabSelected = function VisualPresenter_tabSelected(
  aDocContext,
  aVCContext
) {
...
AndroidPresenter.prototype.liveRegion = function AndroidPresenter_liveRegion(
  aContext,
  aIsPolite,
  aIsHide,
  aModifiedText
...
AndroidPresenter.prototype.noMove = function AndroidPresenter_noMove(
  aMoveMethod
) {
  return {
    type: this.type,
...
B2GPresenter.prototype.keyboardEchoSetting = new PrefCache(
...
B2GPresenter.prototype.pivotChanged = function B2GPresenter_pivotChanged(
  aPosition,
  aOldPosition,
  aStartOffset,
  aEndOffset,
...
B2GPresenter.prototype.nameChanged = function B2GPresenter_nameChanged(
  aAccessible,
  aIsPolite = true
) {
  return {
...
B2GPresenter.prototype.valueChanged = function B2GPresenter_valueChanged(
  aAccessible,
  aIsPolite = true
) {
...
B2GPresenter.prototype.textChanged = function B2GPresenter_textChanged(
  ...
  if (
    echoSetting == this.CHARACTER_ECHO ||
  ...
  if (
    ...
    let maybeWord = accText.getTextBeforeOffset(
      aStart + 1,
      Ci.nsIAccessibleText.BOUNDARY_WORD_END,
      startAfter,
      endAfter
...
B2GPresenter.prototype.actionInvoked = function B2GPresenter_actionInvoked(
  aObject,
  aActionName
) {
  return {
...
B2GPresenter.prototype.liveRegion = function B2GPresenter_liveRegion(
  aContext,
  aIsPolite,
  aIsHide,
  aModifiedText
...
B2GPresenter.prototype.announce = function B2GPresenter_announce(
  aAnnouncement
) {
  return {
    type: this.type,
...
B2GPresenter.prototype.noMove = function B2GPresenter_noMove(aMoveMethod) {
  return {
    type: this.type,
    details: {
      eventType: "no-move",
...
export const Presentation = {
  ...
  pivotChanged: function Presentation_pivotChanged(
    ...
    if (context.accessible) {
      this.displayedAccessibles.set(
        context.accessible.document.window,
        context
      );
    }
  ...
  textChanged: function Presentation_textChanged(
    aAccessible,
    aIsInserted,
    aStartOffset,
    aLength,
  ...
  liveRegion: function Presentation_liveRegion(
    aAccessible,
    aIsPolite,
    aIsHide,
    aModifiedText
