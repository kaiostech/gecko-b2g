...
add_test(function test_Address_decode() {
  ...
  wsp_decode_test(
    MMS.Address,
    strToCharCodeArray("a23456789/TYPE=PLMN"),
    null,
    "CodeError"
  );
  wsp_decode_test(
  ...
  wsp_decode_test(
    MMS.Address,
    strToCharCodeArray("1.2.3.256/TYPE=IPv4"),
    null,
    "CodeError"
  );
  wsp_decode_test(
    MMS.Address,
    strToCharCodeArray("1.2.3.00/TYPE=IPv4"),
    null,
    "CodeError"
  );
  wsp_decode_test(
    MMS.Address,
    strToCharCodeArray("1.2.3.a/TYPE=IPv4"),
    null,
    "CodeError"
  );
  wsp_decode_test(
    MMS.Address,
    strToCharCodeArray("1.2.3/TYPE=IPv4"),
    null,
    "CodeError"
  );
  ...
  wsp_decode_test(
    MMS.Address,
    strToCharCodeArray("1:g:3:4:5:6:7:8/TYPE=IPv6"),
    null,
    "CodeError"
  );
  wsp_decode_test(
    MMS.Address,
    strToCharCodeArray("1::3:4::6:7:8/TYPE=IPv6"),
    null,
    "CodeError"
  );
  ...
  wsp_decode_test(
    MMS.Address,
    strToCharCodeArray("addr/TYPE=type!"),
    null,
    "CodeError"
  );
  wsp_decode_test(
  ...
  wsp_decode_test(MMS.Address, strToCharCodeArray("++123"), null, "CodeError");
  wsp_decode_test(MMS.Address, strToCharCodeArray("!123"), null, "CodeError");
  wsp_decode_test(MMS.Address, strToCharCodeArray("1*23"), null, "CodeError");
  ...
  wsp_decode_test(MMS.Address, strToCharCodeArray("H0w_D0_Y0u_Turn_Th1s_0n"), {
    address: "H0w_D0_Y0u_Turn_Th1s_0n",
    type: "alphanum",
  });

  wsp_decode_test(MMS.Address, strToCharCodeArray("abc#"), null, "CodeError");

  // Test for email address
  wsp_decode_test(MMS.Address, strToCharCodeArray("Joe User <joe@user.org>"), {
    address: "Joe User <joe@user.org>",
    type: "email",
  });
  wsp_decode_test(
    MMS.Address,
    strToCharCodeArray(
      "a-z.A-.Z.0-9!#$.%&.'*+./=?^._`{|}~-@a-.zA-Z.0-9!.#$%&'.*+/=?.^_`.{|}~-"
    ),
    {
      address:
        "a-z.A-.Z.0-9!#$.%&.'*+./=?^._`{|}~-@a-.zA-Z.0-9!.#$%&'.*+/=?.^_`.{|}~-",
  ...
  wsp_decode_test(MMS.Address, strToCharCodeArray("@@@@@"), null, "CodeError");
...
add_test(function test_Address_encode() {
  ...
  wsp_encode_test(
    MMS.Address,
    { address: "1.2.3.256", type: "IPv4" },
    null,
    "CodeError"
  );
  wsp_encode_test(
    MMS.Address,
    { address: "1.2.3.00", type: "IPv4" },
    null,
    "CodeError"
  );
  wsp_encode_test(
    MMS.Address,
    { address: "1.2.3.a", type: "IPv4" },
    null,
    "CodeError"
  );
  wsp_encode_test(
    MMS.Address,
    { address: "1.2.3", type: "IPv4" },
    null,
    "CodeError"
  );
  ...
  wsp_encode_test(
    MMS.Address,
    { address: "1:g:3:4:5:6:7:8", type: "IPv6" },
    null,
    "CodeError"
  );
  wsp_encode_test(
    MMS.Address,
    { address: "1::3:4:5:6::8", type: "IPv6" },
    null,
    "CodeError"
  );
...
add_test(function test_HeaderField_encode() {
  ...
  wsp_encode_test(
    MMS.HeaderField,
    { name: "X-Mms-Message-Type", value: MMS_PDU_TYPE_SEND_REQ },
...
add_test(function test_MmsHeader_encode() {
  ...
  wsp_encode_test(
    MMS.MmsHeader,
    { name: "X-No-Such-Field", value: null },
    null,
    "NotWellKnownEncodingError"
  );
...
add_test(function test_ContentLocationValue_decode() {
  ...
  for (
    let type = MMS_PDU_TYPE_SEND_REQ;
    type <= MMS_PDU_TYPE_CANCEL_CONF;
    type++
  ) {
    if (
...
add_test(function test_ElementDescriptorValue_decode() {
  wsp_decode_test(MMS.ElementDescriptorValue, [2, 97, 0], {
    contentReference: "a",
  });
...
add_test(function test_Parameter_decode() {
  wsp_decode_test(MMS.Parameter, [0x80 | 0x02, 0x80 | 0x00], {
    name: "type",
    value: 0,
  });
...
add_test(function test_Parameter_encode() {
  ...
  wsp_encode_test(MMS.Parameter, { name: "name", value: 0 }, [
    110,
    97,
    109,
    101,
...
add_test(function test_EncodedStringValue_decode() {
  ...
  conv = Cc["@mozilla.org/intl/scriptableunicodeconverter"].createInstance(
    Ci.nsIScriptableUnicodeConverter
  );
  conv.charset = entry.converter;
  ...
  wsp_decode_test(
    MMS.EncodedStringValue,
    [raw.length + 3, 2, 3, 247].concat(raw),
    str
  );
...
add_test(function test_PreviouslySentByValue_decode() {
  wsp_decode_test(MMS.PreviouslySentByValue, [3, 0x80 | 0x03, 65, 0], {
    forwardedCount: 3,
    originator: { address: "A", type: "alphanum" },
  });
...
add_test(function test_PduHelper_parseHeaders() {
  function parse(input, expect, exception) {
    ...
    do_check_throws(
      wsp_test_func.bind(null, MMS.PduHelper.parseHeaders, data, expect),
      exception
    );
  }
  ...
  parse(
    [
      0x80 | 0x0d,
      0x80 | MMS_VERSION_1_3, // X-Mms-Mms-Version: 1.3
      0x80 | 0x04,
      0x80 | 0x33, // Content-Type: application/vnd.wap.multipart.related
      0x80 | 0x0c,
      MMS_PDU_TYPE_SEND_REQ, // X-Mms-Message-Type: M-Send.req
    ],
    expect
  );
  ...
  parse(
    Array.concat([0x80 | 0x17])
      .concat(strToCharCodeArray("+123/TYPE=PLMN"))
      .concat([0x80 | 0x17])
      .concat(strToCharCodeArray("+456"))
...
add_test(function test_PduHelper_encodeHeaders() {
  ...
  wsp_encode_test_ex(
    ...
    Array.concat([0x80 | 0x0c, MMS_PDU_TYPE_SEND_REQ])
      .concat([0x80 | 0x18])
      .concat(strToCharCodeArray(headers["x-mms-transaction-id"]))
