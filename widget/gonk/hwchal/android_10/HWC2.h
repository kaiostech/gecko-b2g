...
class Device {
 public:
  ...
  Error getDisplayIdentificationData(hwc2_display_t hwcDisplayId,
                                     uint8_t* outPort,
...
class Display {
 public:
    ...
    class Builder {
     public:
      ...
      std::shared_ptr<const Config> build() {
        return std::const_pointer_cast<const Config>(std::move(mConfig));
      }
  ...
  virtual const std::unordered_set<DisplayCapability>& getCapabilities()
      const = 0;
  ...
  [[clang::warn_unused_result]] virtual Error getActiveConfigIndex(
      int* outIndex) const = 0;
  ...
  [[clang::warn_unused_result]] virtual int32_t getSupportedPerFrameMetadata()
      const = 0;
  ...
  [[clang::warn_unused_result]] virtual Error getName(
      std::string* outName) const = 0;
  ...
  [[clang::warn_unused_result]] virtual Error getType(
      DisplayType* outType) const = 0;
  [[clang::warn_unused_result]] virtual Error supportsDoze(
      bool* outSupport) const = 0;
  [[clang::warn_unused_result]] virtual Error getHdrCapabilities(
      android::HdrCapabilities* outCapabilities) const = 0;
  [[clang::warn_unused_result]] virtual Error
  getDisplayedContentSamplingAttributes(android::ui::PixelFormat* outFormat,
  ...
  [[clang::warn_unused_result]] virtual Error getReleaseFences(
      std::unordered_map<Layer*, android::sp<android::Fence>>* outFences)
      const = 0;
  ...
  [[clang::warn_unused_result]] virtual Error setClientTarget(
      ...
      android::ui::Dataspace dataspace, const android::Region& damage) = 0;
  [[clang::warn_unused_result]] virtual Error setClientTarget(
      uint32_t slot, const android::sp<android::GraphicBuffer>& target,
      const android::sp<android::Fence>& acquireFence,
  ...
  [[clang::warn_unused_result]] virtual Error setVsyncEnabled(
      Vsync enabled) = 0;
  [[clang::warn_unused_result]] virtual Error validate(
  ...
  [[clang::warn_unused_result]] virtual Error setDisplayBrightness(
...
class Display : public HWC2::Display {
 public:
  ...
  Error getActiveConfig(
      std::shared_ptr<const Config>* outConfig) const override;
  Error getActiveConfigIndex(int* outIndex) const override;
  Error getChangedCompositionTypes(
      std::unordered_map<Layer*, Composition>* outTypes) override;
  Error getColorModes(
      std::vector<android::ui::ColorMode>* outModes) const override;
  // Returns a bitmask which contains HdrMetadata::Type::*.
  int32_t getSupportedPerFrameMetadata() const override;
  Error getRenderIntents(
      android::ui::ColorMode colorMode,
  ...
  Error getHdrCapabilities(
      android::HdrCapabilities* outCapabilities) const override;
  ...
  Error setActiveConfig(
      const std::shared_ptr<const HWC2::Display::Config>& config) override;
  ...
  Error setColorTransform(const android::mat4& matrix,
                          android_color_transform_t hint) override;
  Error setOutputBuffer(
      const android::sp<android::GraphicBuffer>& buffer,
  ...
  const std::unordered_set<DisplayCapability>& getCapabilities()
      const override {
...
class Layer {
 public:
  ...
  [[clang::warn_unused_result]] virtual Error setCursorPosition(int32_t x,
                                                                int32_t y) = 0;
  ...
  [[clang::warn_unused_result]] virtual Error setSurfaceDamage(
  ...
  [[clang::warn_unused_result]] virtual Error setCompositionType(
      Composition type) = 0;
  [[clang::warn_unused_result]] virtual Error setDataspace(
      android::ui::Dataspace dataspace) = 0;
  [[clang::warn_unused_result]] virtual Error setPerFrameMetadata(
      const int32_t supportedPerFrameMetadata,
      const android::HdrMetadata& metadata) = 0;
  [[clang::warn_unused_result]] virtual Error setDisplayFrame(
  ...
  [[clang::warn_unused_result]] virtual Error setSourceCrop(
      const android::FloatRect& crop) = 0;
  [[clang::warn_unused_result]] virtual Error setTransform(
      Transform transform) = 0;
  [[clang::warn_unused_result]] virtual Error setVisibleRegion(
      const android::Region& region) = 0;
  [[clang::warn_unused_result]] virtual Error setZOrder(uint32_t z) = 0;
  [[clang::warn_unused_result]] virtual Error setInfo(uint32_t type,
                                                      uint32_t appId) = 0;
