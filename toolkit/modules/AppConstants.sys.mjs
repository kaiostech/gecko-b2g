...
// is "linux". Add the distinction for code that needs it.
  ...
  KAIOS_ZAXIS_CALI_API_KEY: "@MOZ_KAIOS_ZAXIS_CALI_API_KEY@",
  KAIOS_ZAXIS_ECALL_API_KEY: "@MOZ_KAIOS_ZAXIS_ECALL_API_KEY@",
  KAIOS_ZAXIS_SERVER_DELIVERY_API_KEY: "@MOZ_KAIOS_ZAXIS_SERVER_DELIVERY_API_KEY@",
  KAIOS_ZAXIS_DEVICE_DELIVERY_API_KEY: "@MOZ_KAIOS_ZAXIS_DEVICE_DELIVERY_API_KEY@",
