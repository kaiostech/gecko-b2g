...
const MSG_TURKISH_LONG =
  "Sinan Akçıl-Ebru Şallı cephesinde sular durulmuyor. \
...
const MSG_TURKISH_MULTI_SEGS =
  "ABD'de Başkan Barack Obama'nın kendisini \
...
function verifySegmentInfo(segmentInfo, expectedSegmentInfo, msg) {
  ...
  is(
    segmentInfo.charsAvailableInLastSegment,
    expectedSegmentInfo.charsAvailableInLastSegment,
    msg
  );
}
        ...
        verifySegmentInfo(
          segmentInfo,
          {
            ...
            charsAvailableInLastSegment:
              149 - (MSG_TURKISH_MULTI_SEGS.length % 149),
          },
          "Turkey / GSM 7 bits / shortest dual segments Turkish message."
        )
      )
