...
add_test(function test_Header_decode() {
  wsp_decode_test(WSP.Header, [0x34 | 0x80, 0x80], {
    name: "push-flag",
    value: 0,
  });
...
add_test(function test_ApplicationHeader_decode() {
  ...
  wsp_decode_test(WSP.ApplicationHeader, [65, 0, 66, 0], {
    name: "a",
    value: "B",
  });
  // Test for skipValue
...
add_test(function test_ApplicationHeader_encode() {
  ...
  wsp_encode_test(
    ...
    { name: undefined, value: "asdf" },
    null,
    "CodeError"
  );
  wsp_encode_test(
    WSP.ApplicationHeader,
    { name: null, value: "asdf" },
    null,
    "CodeError"
  );
  wsp_encode_test(
  ...
  wsp_encode_test(
    WSP.ApplicationHeader,
    { name: "asdf", value: undefined },
    strToCharCodeArray("asdf").concat([0])
  );
  wsp_encode_test(
    WSP.ApplicationHeader,
    { name: "asdf", value: null },
    strToCharCodeArray("asdf").concat([0])
  );
  wsp_encode_test(
    WSP.ApplicationHeader,
...
add_test(function test_PduHelper_composeMultiPart() {
  let multiStream = Components.classes[
