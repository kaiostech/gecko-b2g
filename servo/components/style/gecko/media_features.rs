...
fn eval_prefers_text_size(context: &Context, query_value: Option<PrefersTextSize>,) -> bool {
    let prefers_text_size =
        unsafe { bindings::Gecko_MediaFeatures_PrefersTextSize(context.device().document()) };
    match query_value {
