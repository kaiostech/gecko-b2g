...
add_task(
  async function test_storage_local_data_migration_quota_exceeded_error() {
    ...
    equal(
      ...
      false,
      `Got ${IDB_MIGRATED_PREF_BRANCH} preference set to false as expected`
    );
