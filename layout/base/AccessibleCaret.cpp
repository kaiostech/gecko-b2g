...
static constexpr auto kSelectionBarElementId = u"bar"_ns;
...
dom::Element* AccessibleCaret::SelectionBarElement() const {
  return mCaretElementHolder->Root()->GetElementById(kSelectionBarElementId);
}
...
void AccessibleCaret::CreateCaretElement() const {
  ...
  CreateAndAppendChildElement(kSelectionBarElementId);
