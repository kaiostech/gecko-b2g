...
[Exposed=Window,
 Func="B2G::HasNetworkStatsSupport",
 JSImplementation="@mozilla.org/networkStatsManager;1"]
interface NetworkStatsManager {
  /**
   ...
   * start/end will treat as Date objects.
   *
   * If success, the request result will be an NetworkStats object.
   */
  DOMRequest getSamples(NetworkStatsInterface network,
                        object start,
                        object end,
   ...
   */
  DOMRequest addAlarm(NetworkStatsInterface network,
                      long long threshold,
   ...
   *  - data
   */
  DOMRequest getAllAlarms(optional NetworkStatsInterface network);
   ...
   */
  DOMRequest clearStats(NetworkStatsInterface network);
   ...
   */
  DOMRequest getAvailableNetworks(); // array of NetworkStatsInterface.
