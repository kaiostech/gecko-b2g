...
class SensorsWrapperV1_0
    : public SensorsWrapperBase<hardware::sensors::V1_0::ISensors> {
 public:
...
class SensorsWrapperV2_0
    : public SensorsWrapperBase<hardware::sensors::V2_0::ISensors> {
 public:
