...
NS_IMPL_ISUPPORTS(nsDeviceContextSpecGonk, nsIDeviceContextSpec)

nsDeviceContextSpecGonk::~nsDeviceContextSpecGonk() {
  if (mTempFile) {
    mTempFile->Remove(false);
  }
}

already_AddRefed<PrintTarget> nsDeviceContextSpecGonk::MakePrintTarget() {
  double width, height;
...
NS_IMETHODIMP
nsDeviceContextSpecGonk::BeginDocument(const nsAString& aTitle,
